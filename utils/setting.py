...
def parse_opts():
    ...
    parser.add_argument(
        ...
        default=2,
        type=int,
        help="Number of segmentation or classification classes"
    )
    parser.add_argument(
    ...
    args.save_folder = "./trails/{}_cls_models/{}_{}".format(args.n_classes, args.model, args.model_depth)
